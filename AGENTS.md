...
non-streaming OpenAI-compatible API, four tools (`read_file`, `write_file`,
...
- Non-streaming `/chat/completions` with full transcript replay.
...
- Reasoning-model `reasoning_content` is never echoed back to the API
